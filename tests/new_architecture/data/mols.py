...
), 'kekule': 'NC(CC1=CC=CC2=N[NH]C(=O)N12)C(=O)O', 'index': 139, 'backbone': 'alpha',
...
), 'kekule': 'NC(CC(=O)O)CC1=CC=CC2=N[NH]C(=O)N12', 'index': 140, 'backbone': 'beta2',
    'sidechain': 'af', 'connection': 'methyl', 'imported': False}
TEST_MONOMER_5 = {'binary': Chem.MolFromSmiles('NCC(CC1=CC=CC2=N[NH]C(=O)N12)C(=O)O').ToBinary(
), 'kekule': 'NCC(CC1=CC=CC2=N[NH]C(=O)N12)C(=O)O', 'index': 141, 'backbone': 'beta3',
    'sidechain': 'af', 'connection': 'methyl', 'imported': False}
