...
RESULT_SMARTS_1 = f'(Oc1[cH:{rxns.FriedelCrafts.NUCLEOPHILE_EAS_MAP_NUM}]cc([*:{rxns.FriedelCrafts.NUCLEOPHILE_WC_MAP_NUM}])cc1.C(=C/[*:{models.Template.FRIEDEL_CRAFTS_WC_MAP_NUM}])\\[CH3:{models.Template.FRIEDEL_CRAFTS_EAS_MAP_NUM}])>>Oc1ccc([*:{rxns.FriedelCrafts.NUCLEOPHILE_WC_MAP_NUM}])c[c:{rxns.FriedelCrafts.NUCLEOPHILE_EAS_MAP_NUM}]1[CH2:{models.Template.FRIEDEL_CRAFTS_EAS_MAP_NUM}]/C=C/[*:{models.Template.FRIEDEL_CRAFTS_WC_MAP_NUM}]'
RESULT_SMARTS_2 = f'(O=[C:{rxns.FriedelCrafts.BACKBONE_CARBOXYL_MAP_NUM}]([C@@H]1C[C@H](Oc2cc[cH:{rxns.FriedelCrafts.NUCLEOPHILE_EAS_MAP_NUM}]cc2)CN1[*:{rxns.FriedelCrafts.N_TERM_WILDCARD_MAP_NUM}])[*:{rxns.FriedelCrafts.C_TERM_WILDCARD_MAP_NUM}].C(=C/[*:{models.Template.FRIEDEL_CRAFTS_WC_MAP_NUM}])\\[CH3:{models.Template.FRIEDEL_CRAFTS_EAS_MAP_NUM}])>>O=[C:{rxns.FriedelCrafts.BACKBONE_CARBOXYL_MAP_NUM}]([C@@H]1C[C@H](Oc2cc[c:{rxns.FriedelCrafts.NUCLEOPHILE_EAS_MAP_NUM}]([CH2:{models.Template.FRIEDEL_CRAFTS_EAS_MAP_NUM}]/C=C/[*:{models.Template.FRIEDEL_CRAFTS_WC_MAP_NUM}])cc2)CN1[*:{rxns.FriedelCrafts.N_TERM_WILDCARD_MAP_NUM}])[*:{rxns.FriedelCrafts.C_TERM_WILDCARD_MAP_NUM}]'


@pytest.mark.parametrize('model_mol,template,atom_idx,expected', [(SIDECHAIN, TEMPLATE_1, 3, RESULT_SMARTS_1),
                                                                  (SIDECHAIN, TEMPLATE_2, 3, RESULT_SMARTS_1),
                                                                  (SIDECHAIN, TEMPLATE_3, 3, RESULT_SMARTS_1),
                                                                  (MONOMER, TEMPLATE_1, 10, RESULT_SMARTS_2),
                                                                  (MONOMER, TEMPLATE_2, 10, RESULT_SMARTS_2),
                                                                  (MONOMER, TEMPLATE_3, 10, RESULT_SMARTS_2)])
